...
Program one_d_advt_burgers_FTBS
  ...
  real(kind=8),parameter::c=1,sigma=0.4
...
1010 format(' t = ', es24.14)
  ...
  call one_d_adv_burgers_FTBS(dt,t,dx,x,u0,u);filename='one_d_advt_burgers_FTBS'
...
end program one_d_advt_burgers_FTBS
