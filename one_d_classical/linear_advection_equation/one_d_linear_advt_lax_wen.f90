...
Program one_d_linear_advt_lax_wen
...
1010 format(' t = ', es24.14)
  ...
  call one_d_linear_adv_Lax_Wen(c,dt,t,dx,x,u0,u);filename='one_d_linear_advt_lax_wen'
...
end program one_d_linear_advt_lax_wen
