...
Program one_d_linear_advection_FTCS
...
1010 format(' t = ', es24.14)
  ...
  !============one_d_linear_advection: ============
   ...
   call one_d_linear_adv_FTCS(c,dt,t,dx,x,u0,u); filename='one_d_linear_advection_FTCS'
...
end program one_d_linear_advection_FTCS
