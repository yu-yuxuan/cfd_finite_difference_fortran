...
Program one_d_linear_advection_FTBS
...
1010 format(' t = ', es24.14)
  ...
  !============one_d_linear_advection: ============
   ...
   call one_d_linear_adv_FTBS(c,dt,t,dx,x,u0,u); filename='one_d_linear_advection_FTBS'
...
end program one_d_linear_advection_FTBS
