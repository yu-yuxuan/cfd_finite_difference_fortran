...
Program one_d_linear_advection_BTCS
  ...
  implicit none
  integer::isetval
  integer,parameter ::ispace=100,itime=400
  real(kind=8),parameter::c=1,sigma=0.8,epsilon=1.0d-14
...
1010 format(' t = ', es24.14)
  ...
  !============one_d_linear_advection: ============
   ...
   call one_d_linear_adv_BTCS(c,dt,t,dx,x,u0,u,epsilon); filename='one_d_linear_advection_BTCS'
...
end program one_d_linear_advection_BTCS
